    ...
    <div>
      <div className={theme ? 'container-outside' : 'container-1'}>
        ...
        <div className={theme ? 'dark-landing' : 'columns-landing'}>
          ...
          <div className={theme ? 'landing-2' : 'columns-landing-2'}>
            <div>
              <Link
                to="/features"
                className={theme ? 'dark-login' : 'login-from-landing'}
              >
                Features
              </Link>
              <a
              ...
              <a
                href="#contact"
                className={theme ? 'dark-register' : 'register-from-landing'}
              >
                Contact
              </a>
            </div>
            <div className={theme ? 'dark-image1-out' : 'image1-out'}>
              <div className={theme ? 'dark-image1-head' : 'image1-head'}>
                Create a room and stay connected
              </div>
              <img
                className="image1"
                src="https://miro.medium.com/max/3200/1*U0xqOjpBt-Xxkz3i5xbs_w.png"
              ></img>
            </div>
          </div>
        </div>
        ...
        <div className={theme ? 'dark-connect-landing' : 'connect-landing'}>
          <div
            className={
              theme ? 'dark-connect-landing-outer' : 'connect-landing-outer'
            }
          >
            ...
            <div className={theme ? 'dark-connect-main' : 'connect-main'}>
              <div
                className={theme ? 'dark-connect-head-in' : 'connect-head-in'}
              >
                Stay Connected
              </div>
              <div
                className={
                  theme ? 'dark-connect-main-text' : 'connect-main-text'
                }
              >
                Microsoft Teams is an entirely new experience that brings
                together people, conversations and content—along with the tools
                that teams need—so they can easily collaborate to achieve more.
                It’s naturally integrated with the familiar Office applications
                and is built from the ground up on the Office 365 global, secure
                cloud. Starting today, Microsoft Teams is available in preview
                in 181 countries and in 18 languages to commercial customers
                with Office 365 Enterprise or Business plans, with general
                availability expected in the first quarter of 2017.
              </div>
            </div>
          </div>
        </div>
        ...
        <div
          className={theme ? 'dark-about-landning' : 'about-landing'}
          id="about"
        >
          <div className={theme ? 'dark-about-outer' : 'about-outer'}>
            <div className="set-about">
              ...
              <div className={theme ? 'dark-about-head' : 'about-head'}>
                About Us
              </div>
            </div>
            <div className={theme ? 'dark-about-main' : 'about-main'}>
              <span>We believe in what people make possible.</span>
              <br></br>
              <br />
              <br />
              Our mission is to empower every person and every organization on
              the planet to achieve more.<br></br>
              Microsoft Teams offers a wide range of features including video
              calling , text chatting , screen sharing etc.
            </div>
          </div>
        </div>

        <div
          className={theme ? 'dark-contact-landing' : 'contact-landing'}
          id="contact"
        >
          <div className="contact-up">
            ...
            <div className="contact-text">
              <div
                className={
                  theme ? 'dark-contact-text-head' : 'contact-text-head'
                }
              >
                Email Us
              </div>
              <div
                className={
                  theme ? 'dark-contact-text-main' : 'contact-text-main'
                }
              >
                Write us if you have any queries.
              </div>
              <div className={theme ? 'dark-contact-email' : 'contact-email'}>
                anshika.microsoft@gmail.com
              </div>
            </div>
          </div>
        </div>
